...
export const sprints: Sprint[] = [
  ...
  // Gantt with extra words.
  {
    ...
    status: "done",
    members: [
      { memberId: "aditiya", allocation: 100, capacityDays: 10 },
      { memberId: "reyza", allocation: 50, capacityDays: 5 },
    ],
    backlogItemIds: [],
    committed: 30,
    completed: 30,
  ...
  },
  {
    ...
    status: "active",
    members: [
      { memberId: "reyza", allocation: 75, capacityDays: 7.5 },
      { memberId: "christian", allocation: 50, capacityDays: 5 },
    ],
    backlogItemIds: ["sc-b1"],
    committed: 34,
    completed: 12,
    progress: 35,
    risk: "low",
  },
  {
    ...
    members: [
      { memberId: "aditiya", allocation: 100, capacityDays: 10 },
      { memberId: "vinza", allocation: 25, capacityDays: 2.5 },
    ],
    backlogItemIds: ["qc-b1"],
    committed: 26,
    completed: 9,
    progress: 35,
    risk: "high",
  },
  {
    ...
    status: "done",
    members: [
      { memberId: "vinza", allocation: 100, capacityDays: 10 },
  ...
  },
  {
    ...
    daysLeft: 12,
    status: "planning",
    members: [{ memberId: "vinza", allocation: 75, capacityDays: 7.5 }],
    backlogItemIds: ["kb-b1"],
    committed: 20,
    completed: 0,
    progress: 0,
    risk: "medium",
...
export const backlog: BacklogItem[] = [
  {
    ...
    acceptanceCriteria: [
      "Every connected line appears",
      "Values refresh without a reload",
      "A dropped connection is visibly marked",
    ],
    type: "story",
    priority: "high",
    readiness: "ready",
  ...
  },
  {
    ...
    acceptanceCriteria: [
      "Frames are captured at line speed",
      "Each frame carries a timestamp and batch id",
    ],
    type: "story",
    priority: "high",
    readiness: "ready",
  ...
  },
  {
    ...
    acceptanceCriteria: [
      "An answer cites the SOP it came from",
      "No answer is invented when nothing matches",
    ],
    type: "story",
    priority: "medium",
